      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative bg-white/80 backdrop-blur-xl border border-white/20 rounded-3xl p-8 overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="text-center mb-10 pt-4">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Start your journey with Zyrova today
              </p>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <User className="h-5 w-5 text-gray-400 group-hover:text-blue-500 transition-colors duration-300" />
                </div>
                <input
                  type="text"
                  value={formData.name}
            ...
            <div className="space-y-3">
              <label className="text-sm font-semibold text-gray-700 tracking-wide">Confirm Password</label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <Lock className="h-5 w-5 text-gray-400 group-hover:text-blue-500 transition-colors duration-300" />
                </div>
            ...
            <div className="flex items-start gap-4 pt-2">
              <button
                ...
                className="mt-1 flex h-6 w-6 items-center justify-center rounded-lg border-2 border-gray-300 bg-white transition-all hover:border-blue-500 group"
              >
              ...
              <label className="text-sm text-gray-600 leading-relaxed">
                I agree to the{" "}
                <Link href="/terms" className="text-blue-600 font-semibold hover:text-blue-700 transition-colors duration-300 underline">
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link href="/privacy" className="text-blue-600 font-semibold hover:text-blue-700 transition-colors duration-300 underline">
                  Privacy Policy
                </Link>
              </label>
            </div>
            ...
            <div className="relative my-10">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-6 bg-white text-gray-500 font-medium">Or sign up with</span>
              </div>
            </div>
          ...
          <div className="mt-10 text-center">
            <p className="text-gray-600 text-lg">
              ...
              <Link href="/login" className="text-blue-600 font-semibold hover:text-blue-700 transition-colors duration-300">
                Sign in
              </Link>
            </p>
          </div>
